...
typedef struct process {
	...
	int p_exit_status;		// Process's exit status
        ...
        unsigned int p_share;           // Process share - 4B
        unsigned int p_count;      // Number of times a process has ran - 4B
        unsigned int p_tickets;  // Number of tickets for the lottery system
} process_t;
